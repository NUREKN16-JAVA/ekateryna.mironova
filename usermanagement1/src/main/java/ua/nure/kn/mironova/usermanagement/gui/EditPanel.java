...
public class EditPanel extends JPanel implements ActionListener {
    ...
    private JButton getCancelButton() {
        if (cancelButton == null) {
            ...
            cancelButton.setText(""); //$NON-NLS-1$
    ...
    private JPanel getFieldPanel() {
        if (fieldPanel == null) {
            ...
            addLabeledField(fieldPanel, "", getFirstNameField()); //$NON-NLS-1$
            addLabeledField(fieldPanel, "", getLastNameField()); //$NON-NLS-1$
            addLabeledField(fieldPanel, "", getDateOfBirthField()); //$NON-NLS-1$
    ...
    public void actionPerformed(ActionEvent e) {
        if (Messages.getString("EditPanel.ok").equalsIgnoreCase(e.getActionCommand())) { //$NON-NLS-1$
